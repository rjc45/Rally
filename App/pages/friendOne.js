        ...
        <View style={styles.eventsLists}>
          ...
          >
            <CardView 
              ...
              style={styles.cards}
            >
              <Text style={styles.cardText}>Gender Equality</Text>
            </CardView>
            <CardView 
              cardElevation={2}
              cardMaxElevation={2}
              ...
              style={styles.cards}
            >
              <Text style={styles.cardText}>Sexual Health</Text>
            </CardView>
          </ScrollView> 
        </View>
        ...
        <View style={styles.eventsLists}>
          ...
          >
            <CardView 
              ...
              style={styles.cards}
            >
              <Text style={styles.cardText}>Sexual Violence Town Hall with the Provost</Text>
              <Text>12/03/2019</Text>
              <Text>Bldg. 200-002</Text>
            </CardView>
